...
export class NodeShape extends Shape {
    ...
    couldBeSkosConcept():boolean {
        ...
        let isItselfSkosConcept:boolean = (this.resource.value == SKOS.CONCEPT.value);
        let targetsSkosConcept:boolean = (this.getShTargetClass().findIndex(t => t.value == SKOS.CONCEPT.value) > -1);
