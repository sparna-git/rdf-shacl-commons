...
export class SparqlHandlerFactory {
    ...
    protected customizedSparqlHandler?:SparqlHandlerIfc | undefined;
    protected catalog?:Catalog | undefined;
    ...
    buildSparqlHandler(endpoints:string[]):SparqlHandlerIfc {
        ...
        if(endpoints.length > 1) {
            if(!this.catalog) {
                throw new Error("Cannot use multiple endpoints without a catalog");
            }
            ...
            let endpoint:string = endpoints[0] as string;
